...
import axios from "axios";                                                 
     ...
     import VolunteerOpportunitiesDashboard from                                
     "./pages/VolunteerOpportunitiesDashboard";                                 
     import QuestionsAndAnswers from                                            
     "./pages/QuestionsAndAnswers";                                             
     import DuaRequestWall from "./pages/DuaRequestWall";                       
     import ContactUs from "./pages/ContactUs";                                 
     import Profile from "./pages/Profile";                                     
     import SignUp from "./pages/SignUp";                                       
     import Login from "./pages/Login";                                         
     import NewsletterSubscribersDashboard from                                 
     "./pages/NewsletterSubscribersDashboard";                                  
     import IslamicQuotesDashboard from                                         
     "./pages/IslamicQuotesDashboard";                                          
...
// import SignUpSuccess from "./pages/SignUpSuccess";
     ...
     />} />                                                                     
             ...
             {/* Blog And Articles */}                                          
             <Route path="blog_and_articles"                                    
     element={<BlogAndArticles />} />                                           
     ...
     />} />                                                                     
             ...
             <Route path="volunteer_board"                                      
     element={<VolunteerBoard />} />                                            
                                                                                
             <Route path="questions_and_answers"                                
     ...
     element={<ResourceDashboard />} />                                         
             ...
             <Route path="qa_dashboard"                                         
     element={<ScholarQADashboard />} /> 

             {/* Donations Dashboard */}                                       
             <Route path="donations_dashboard"                                         
