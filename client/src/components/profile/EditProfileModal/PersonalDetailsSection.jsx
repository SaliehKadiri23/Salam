...
const PersonalDetailsSection = ({ formData, onInputChange }) => {
  const languageOptions = [
    ...
    'Indonesian', 'Malay', 'Bengali', 'Persian', 'Hindi', 'German'
  ];
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        {/* Location */}
        <FormField label="Location" helper="City and country where you're based">
        ...
        {/* Languages */}
        <FormField label="Languages Spoken" helper="Select all languages you can communicate in">
