    ...
    <div className="relative">
      ...
      <div className="relative">
        <button
          ...
          className="w-full p-3 dark:text-gray-100 bg-white dark:bg-black/40 border border-slate-200 dark:border-emerald-600 rounded-xl shadow-sm focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-teal-500 transition-all duration-300 flex items-center justify-between hover:border-slate-300 hover:shadow-md"
        >
          <span
            className={
              value === "All"
