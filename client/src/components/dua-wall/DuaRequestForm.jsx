    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
      <div className="bg-white rounded-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        ...
        <div className="flex items-center justify-between p-6 border-b border-gray-100">
          <h2 className="text-2xl font-bold text-gray-900">Share Your Dua Request</h2>
          <button
            onClick={onClose}
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          ...
          <div className="flex items-center justify-between p-4 bg-gray-50 rounded-xl">
            ...
            <button
              ...
              className={`
                ...
                ${formData.isAnonymous ? 'bg-emerald-600' : 'bg-gray-200'}
              `}
            >
              <span
                className={`
          ...
          <div className="flex gap-3 pt-4">
            ...
            <button
              type="submit"
              disabled={isSubmitting || !formData.content.trim() || (!formData.isAnonymous && !formData.author.trim())}
              className={`
                ...
                ${isSubmitting || !formData.content.trim() || (!formData.isAnonymous && !formData.author.trim())
